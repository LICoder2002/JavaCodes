...
/*
    文件上传的客户端: 读取本地文件到服务器， 上传到服务器，读取服务器回写的数据

    实现步骤:
        1. 创建一个本地字节输入流FileInputStream的对象，构造方法中绑定要读取的数据源
        2. 创建一个客户端Socket对象，构造方法中绑定服务器的IP地址和端口号
        3. 使用Socket中的方法getOutputStream，获取网络字节输出流OutputStream对象
        4. 使用本地字节输入流FileInputStream对象中的方法read读取本地文件
        5. 使用网络字节输出流OutputStream对象中的方法write，把读取到的文件上传到服务器
        6. 使用Socket中的方法getInputStream，获取网络字节输出流InputStream对象
        7. 使用网络字节输出流InputStream对象中的方法read，读取服务器回写的数据
        8. 释放资源（FileInputStream, Socket)
 */
public class TCPClient {
    public static void main(String[] args) throws IOException {
        //1. 创建一个本地字节输入流FileInputStream的对象，构造方法中绑定要读取的数据源
        FileInputStream fis = new FileInputStream("D:\\MySQL\\文档\\MySQL-基础篇.pdf");
        //2. 创建一个客户端Socket对象，构造方法中绑定服务器的IP地址和端口号
